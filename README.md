...
# Reports
## Test Report
The test report can be found [here](supplementary/reports/tests/test/index.html)!
<iframe src="file:////supplementary/reports/tests/test/index.html" width="100%" height="500px"></iframe>

## Coverage Report
The coverage report can be found [here](supplementary/reports/jacocoHTML/index.html)!
<iframe src="file:////supplementary/reports/jacocoHTML/index.html" width="100%" height="500px"></iframe>

---

# Documentations
The documentations (generated by JavaDoc) can be found [here](docs/index.html)!
<iframe src="file:////docs/index.html" width="100%" height="500px"></iframe>

---

# Supplementary Notes
The supplementary notes can be found [here](supplementary/supplementaryNotes.pdf)!
<iframe src="file:////supplementary/supplementaryNotes.pdf" width="100%" height="500px"></iframe>